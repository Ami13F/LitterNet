...
import com.kotlinapp.entities.PasswordState
...
class ProfileViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun updateProfile(player: Player) {
        viewModelScope.launch {
            ...
            Log.d(TAG,"country: ${player.country}")
            Log.d(TAG,"score: ${player.score}")
            Log.d(TAG,"idPlayer: ${player.idPlayer}")
            ...
            when(val result= itemRepository.updatePlayer(player)) {
                is Result.Success -> {
                    ...
                    AuthRepository.currentPlayer = AuthRepository.getCurrentPlayer(player.idPlayer!!)
                }
                is Result.Error -> {
